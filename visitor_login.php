                ...
                if ($user_result && mysqli_num_rows($user_result) > 0) {
                    ...
                    if ($user_category == 'admin') {
                        ...
                        if (mysqli_query($conn, $log_sql)) {
                            ...
                            $message = "Your entry request has been submitted. Please wait for admin approval.";
...
<body>
        ...
        <?php if ($welcome_message): ?>
            <script>
                window.onload = function() {
                    showNotification("<?php echo $welcome_message; ?>");
                };
            </script>
        <?php endif; ?>
    ...
    <script>
        ...
        window.addEventListener('load', function() {
            ...
            if (welcomeParam) {
                showNotification('Welcome to the library, ' + decodeURIComponent(welcomeParam) + '! Your entry has been approved.');
            }
        });
